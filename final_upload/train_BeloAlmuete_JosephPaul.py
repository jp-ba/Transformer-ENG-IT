#filename: train_BeloAlmuete_JosephPaul.py

#I. Math


#II. Code
#the following code is for file: train_BeloAlmuete_JosephPaul.py
...
#method: get or build the tokenizer, config of model, dataset, language of tokenizer
...
def train_model(config):
    ...
    #CSCI_440-24-m+c_SummaryWriter.py
    writer = SummaryWriter(config['experiment_name'])

    #create optimizer: Adam
    #Recall Lecture 18
    #https://docs.google.com/presentation/d/1y_40A4h8KeZVZCUIsHaiqmOcez3my4pMkv4xaRCmOxM/edit?slide=id.g3b44d102b9b_0_476#slide=id.g3b44d102b9b_0_476
    ...
    if config['preload']:
        ...
        #indicate ignore index, ignore padding, we don't want the [PAD] token to contribute to the loss
