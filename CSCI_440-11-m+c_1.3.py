#filename: CSCI_440-11-m+c_1.2.py

#I. Math


#II. Code
#matplot lib animations
#https://matplotlib.org/stable/api/animation_api.html
#https://www.youtube.com/watch?v=bq1jjJM7-20#:~:text=Matplotlib%20Series%20Part%2316%20%2D%20How,MP4%20Video%20or%20GIF)%20%2D%20YouTube&text=This%20content%20isn't%20available,.org/dow...
#https://pythonnumericalmethods.studentorg.berkeley.edu/notebooks/chapter12.04-Animations-and-Movies.html#:~:text=You%20can%20create%20animations%20in,the%20animation%20functionality%20is%20built.
